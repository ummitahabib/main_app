...
class FarmManagementOrganizationDetailsPage extends StatefulWidget {
  final String organizationId;

  const FarmManagementOrganizationDetailsPage({
    Key? key,
    required this.organizationId,
  }) : super(key: key);

  @override
  _FarmManagementOrganizationDetailsPageState createState() => _FarmManagementOrganizationDetailsPageState();
}

class _FarmManagementOrganizationDetailsPageState extends State<FarmManagementOrganizationDetailsPage>
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          children: [
                                            ...
                                            FarmMeasurementsMenu(
                                              size: siteArea.toStringAsPrecision(3),
                                            ),
                                          ],
                                        ),
                                      ),
            ...
            children: [
              CategoryChip(
                ...
                () {
                  setState(() {
                    pandora.logAPPButtonClicksEvent(
                      'CLOSE_WEATHER_INFO_BUTTON_CLICKED',
                    );
                    _details = farmManagementWidget();
                  });
                },
            ...
            children: [
              CategoryChip(
                ...
                () {
                  setState(() {
                    pandora.logAPPButtonClicksEvent(
                      'CLOSE_SOIL_INFO_BUTTON_CLICKED',
                    );
                    _details = farmManagementWidget();
                  });
                },
          ...
          Row(
            ...
            children: [
              CategoryChip(
                ...
                () {
                  pandora.logAPPButtonClicksEvent(
                    'CLOSE_SOIL_TEST_BUTTON_CLICKED',
                  );
                  setState(() {
                    _details = farmManagementWidget();
                  });
          ...
          Row(
            ...
            children: [
              CategoryChip(
                ...
                () {
                  pandora.logAPPButtonClicksEvent(
                    'CLOSE_SMAT_STAR_BUTTON_CLICKED',
                  );
                  setState(() {
                    _details = farmManagementWidget();
                  });
          ...
          Row(
            ...
            children: [
              CategoryChip(
                ...
                () {
                  pandora.logAPPButtonClicksEvent(
                    'CLOSE_BATCH_ANALYSIS_BUTTON_CLICKED',
                  );
                  setState(() {
                    _details = farmManagementWidget();
                  });
          ...
          if (element.name == AppPermissions.smat_sat) {
            ...
            _siteChildren.add(
              CategoryChip(
                ...
                () {
                  pandora.logAPPButtonClicksEvent(
                    'SATELLITE_IMAGERY_BUTTON_CLICKED',
                  );
                  setState(() {
                    //_details = satelliteImageryWidget();
                    OneContext().showSnackBar(
                      builder: (_) => const SnackBar(
                        content: Text('Only Available on special request'),
                      ),
                    );
                  });
                },
  ...
  Future getSectorBounds(String sectorId) async {
    ...
    setState(() {
      ...
      _cameraPosition = CameraPosition(
        target: LatLng(
          sectorData!.sectorCoordinates[0][0][0],
          sectorData!.sectorCoordinates[0][0][1],
        ),
        zoom: 16.4746,
      );
      ...
      for (int i = 0; i < sectorData!.sectorCoordinates[0].length; i++) {
        _sectorLatLng.add(
          LatLng(
            sectorData!.sectorCoordinates[0][i][0],
            sectorData!.sectorCoordinates[0][i][1],
          ),
        );
      }
                ...
                children: <Widget>[
                  ...
                  if (batchData!.taskStatus == OrthoPhotoStatus.NONE ||
                    ...
                    CategoryChip(
                      ...
                      () {
                        pandora.logAPPButtonClicksEvent(
                          'BEGIN_PROCESSING_BUTTON_CLICKED',
                        );
                        batchData!.images!.length <= 5
                            ? OneContext().showSnackBar(
                                builder: (_) => const SnackBar(
                                  content: Text(
                                    'You cannot process less than 5 images',
                                  ),
                  ...
                  if (batchData!.taskStatus != OrthoPhotoStatus.COMPLETED)
                    ...
                    CategoryChip(
                      ...
                      () {
                        pandora.logAPPButtonClicksEvent(
                          'VIEW_ORTHOMOSAIC_BUTTON_CLICKED',
                        );
