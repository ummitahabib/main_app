...
//
//     final getMissionById = getMissionByIdFromJson(jsonString);

import 'dart:convert';

GetMissionById getMissionByIdFromJson(String str) => GetMissionById.fromJson(json.decode(str));

String getMissionByIdToJson(GetMissionById data) => json.encode(data.toJson());
...
class GetMissionById {
  ...
  factory GetMissionById.fromJson(Map<String, dynamic> json) => GetMissionById(
        id: json["id"],
