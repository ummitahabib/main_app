...
WeatherHistoryResponse getWeatherHistoryFromJson(String str) => WeatherHistoryResponse.fromJson(json.decode(str));

String getWeatherHistoryToJson(WeatherHistoryResponse data) => json.encode(data.toJson());
