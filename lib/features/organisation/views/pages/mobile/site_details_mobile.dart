...
import 'package:smat_crow/features/organisation/views/pages/mobile/draggable_sheet.dart';
...
class SiteDetailMobile extends StatefulHookConsumerWidget {
  const SiteDetailMobile({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _SiteDetailMobileState();
}

class _SiteDetailMobileState extends ConsumerState<SiteDetailMobile> {
  ...
  Future<void> _getCurrentLocation() async {
    try {
      ...
      if (position != null) {
        await Future(() {
          ref.read(mapProvider).position = position;
          setState(() {
              ...
              children: [
                Stack(
                  ...
                  children: [
                    ...
                    Positioned(
                      bottom: Responsive.yHeight(context, percent: 0.3),
