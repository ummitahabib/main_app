...
import 'package:smat_crow/screens/fieldagents/pages/farmmanagement/farm_management_date_widget.dart';
import 'package:smat_crow/screens/fieldagents/pages/farmmanagement/farm_management_time_widget.dart';
...
class RegisterFarmLog extends StatefulHookConsumerWidget {
  const RegisterFarmLog({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _RegisterFarmLogState();
}

enum LogTypeEnum { activity, observation, tests, health, purchase }

class _RegisterFarmLogState extends ConsumerState<RegisterFarmLog> {
    ...
    useEffect(
      () {
        ...
        if (logController.logResponse != null) {
          ...
          cost.text = (logController.logResponse!.log!.cost ?? 0).toString();
          ...
          farmSeason.value = shared.seasonList
              .firstWhere(
                (element) => element.uuid == logController.logResponse!.log!.farmingSeasonId,
          ...
          child: Column(
            ...
            children: [
                  ...
                  Expanded(
                    child: SelectContainer(
                      ...
                      function: () async {
                        ...
                        await customDialogAndModal(
                          context,
                          FarmManagerDateDialogWidget(
                            selectedDate: (value) {
                              logDate.value['start']!.value = DateFormat("yyyy-MM-dd").format(value);
                            },
                          ),
                          Responsive.isTablet(context),
                        );
                    ...
                    child: SelectContainer(
                      ...
                      function: () async {
                        ...
                        await customDialogAndModal(
                          ...
                          FarmManagerDateDialogWidget(
                            selectedDate: (value) {
                              logDate.value['end']!.value = DateFormat("yyyy-MM-dd").format(value);
                            },
                          ),
                          Responsive.isTablet(context),
                        );
                  ...
                  Expanded(
                    child: SelectContainer(
                      ...
                      function: () async {
                        ...
                        await customDialogAndModal(
                          context,
                          FarmManagerTimeDialogWidget(
                            selectedDate: (value) {
                              timePicked.value['start']!.value = TimeOfDay.fromDateTime(value).format(context);
                    ...
                    child: SelectContainer(
                      ...
                      function: () async {
                        ...
                        await customDialogAndModal(
                          ...
                          FarmManagerTimeDialogWidget(
                            selectedDate: (value) {
                              timePicked.value['end']!.value = TimeOfDay.fromDateTime(value).format(context);
                              endTime.value = value;
                            },
                          ),
                          Responsive.isTablet(context),
              ...
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const BoldHeaderText(text: movementTaskText),
                  const Color600Text(text: isMovementTaskText),
                  ...[yes, no].map(
                    (e) => RadioListTile(
                      contentPadding: EdgeInsets.zero,
              ...
              Builder(
                builder: (context) {
                  if (logType.value == null) return Container();
                  ...
                  if (logType.value!.toLowerCase().contains(LogTypeEnum.tests.name) ||
                      logType.value!.toLowerCase().contains(LogTypeEnum.health.name)) {
                    return TestLogUI(logTestType: logTestType, logLab: logLab);
                  }
              ...
              CustomButton(
                ...
                onPressed: () async {
                  ...
                  if (logType.value!.toLowerCase().contains(LogTypeEnum.purchase.name) && logCurrency.value == null) {
